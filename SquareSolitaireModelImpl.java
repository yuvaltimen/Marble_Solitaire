...
public abstract class SquareSolitaireModelImpl implements MarbleSolitaireModel {
   ...
   *
   * <p>@param armLength represents the length of one edge side of the board.
   *
   * @param sRow represents the row of the initial empty spot.
   * @param sCol represents the column of the initial empty spot.</p>
   */
   ...
   *
   * <p>@param row Represents the row of the empty spot on the board.
   *
   * @param col Represents the column of the empty spot on the board.</p>
   */
   ...
   *
   * <p>@param armLength Represents the length of the arm of the board.
   *
   * @param row Represents the row in the position.
   * @param col Represents the column in the position.
   * @return True if the position is valid, false otherwise.</p>
   */
   ...
   *
   * <p>@param armLength the length of the arm (must be odd and positive).</p>
   */
   ...
   *
   * <p>@param fromRow the row number of the position to be moved from (starts at 0)
   *
   * @param fromCol the column number of the position to be moved from (starts at 0)
   * @param toRow   the row number of the position to be moved to (starts at 0)
   * @param toCol   the column number of the position to be moved to (starts at 0)
   * @throws IllegalArgumentException if the move is not possible</p>
   */
   ...
   *
   * <p>@return true if the game is over, false otherwise</p>
   */
  @Override
   ...
   *
   * <p>@return the game state as a string</p>
   */
  @Override
   ...
   *
   * <p>@return the number of marbles currently on the board</p>
   */
  @Override
  public int getScore() {
    int score = 0;

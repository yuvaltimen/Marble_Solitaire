...
public class TriangleSolitaireModelImpl implements MarbleSolitaireModel {
    ...
    /**
     * Constructor that creates a board of side length 5 and initializes the empty slot at the specified position.
     *
    ...
    /**
     * Constructor that takes in the side length and position of the empty slot and initializes the board.
     *
    ...
    /**
     * Determines whether the position given by (row, col) is valid for a board of the given side length.
     *
    ...
    public void move(int fromRow, int fromCol, int toRow, int toCol) throws IllegalArgumentException {
        ...
        if (fromValid && toValid) {
            ...
            String err = String.format("Invalid origin or destination:(%d,%d)~(%d,%d)", fromRow, fromCol, toRow, toCol);
